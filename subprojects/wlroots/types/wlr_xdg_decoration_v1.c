...
struct wlr_xdg_decoration_manager_v1 *
	...
	uint32_t global_version = version;
	if (global_version > (uint32_t)zxdg_decoration_manager_v1_interface.version) {
		global_version = zxdg_decoration_manager_v1_interface.version;
	}
	manager->global = wl_global_create(display,
		&zxdg_decoration_manager_v1_interface, global_version,
